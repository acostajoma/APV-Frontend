...
const CambiarPassword = () => {
  ...
  return (
    <>
        ...
        <p className="text-xl mb-10 mt-5 text-center">Modifica tu {' '} <span className="text-indigo-600 font-bold">Contraseña</span></p>
            ...
            <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
                ...
                >
                    <div className="my-3">
                        ...
                        <input 
                            type="password" 
                            className="bordpwd_nuevor bg-gray-50 w-full p-2 mt-5 rounded-lg"
                            name="pwd_actual"
